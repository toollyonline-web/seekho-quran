...
const InstallPWA: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 md:bottom-8 md:right-8 md:left-auto z-[60] animate-in slide-in-from-bottom-10 duration-500">
      <div className="bg-green-700 text-white p-4 rounded-2xl shadow-2xl flex items-center justify-between gap-4 border border-green-600">
        ...
        <div className="flex items-center gap-2">
          <button 
            ...
            className="px-4 py-2 bg-white text-green-800 rounded-lg text-xs font-bold hover:bg-green-50 transition-colors"
          >
            Install
          </button>
          <button 
